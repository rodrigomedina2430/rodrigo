...
<body>
    <div class="wrapper ">
        <div class="sidebar" data-background-color="blue" data-image="../assets/img/res.jpg">
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link d-flex" href="marca.php">
                            <i class=" fas fa-marca mr-2 fa-2x"></i>
                            <p> Marca</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        ...
                        <ul class="navbar-nav">
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile">
                                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#nuevo_pass" style="background-color:Chocolate">Perfil</a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="salir.php" style="background-color:Chocolate">Cerrar Sesión</a>
                                </div>
                            </li>
                        </ul>
                    </div>
