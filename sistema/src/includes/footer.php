...
<footer class="footer">
    <div class="container-fluid">
        <div class="copyright float-right">
            ...
            <a href="#" target="_blank">Zona Smartphone</a>.
        </div>
    </div>
</footer> 
</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" id="frmPass">
                    ...
                    <button class="btn btn-primary btn-block" type="button" onclick="btnCambiar(event)" style="background-color:Chocolate">Cambiar</button>
                </form>
            </div>
        </div>
    </div>
