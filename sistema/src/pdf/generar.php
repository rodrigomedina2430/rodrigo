...
$pdf->image("../../assets/img/ventas.png", 60, 15, 15, 15, 'PNG');
...
$pdf->Cell(15, 5, 'Sub Total.', 0, 0, 'L');
$pdf->Cell(30, 5, 'Imagen', 0, 1, 'L');
$pdf->SetFont('Arial', '', 7);
$total = 0.00;
$desc = 0.00;
while ($row = mysqli_fetch_assoc($ventas)) {
    ...
    $pdf->image("../../assets/img/HONOR 50 Lite.jpg", 66, 62, 10, 10, 'JPG');
    $sub_total = $row['total'];
