...
try {
    ...
    $mail->addAttachment('C:\Users\USER\Downloads\PDF\Ticket4171.pdf');
    $mail->addAttachment('C:\Users\USER\Downloads\PDF\Graficas.pdf');    //Optional name

    //Content
    $mail->isHTML(true);                                  //Set email format to HTML
    $mail->Subject = 'COMPAR DE TU CELULAR';
