...
<a href="pdf/objet/obj3D.php?cl=<?php echo $row['id_cliente'] ?>&v=<?php echo $row['id'] ?>" target="_blank" class="btn btn-danger" style="background-color:OrangeRed"><i class="fas fa-file-pdf"></i></a>


<a href="pdf/Graficas.pdf?cl=<?php echo $row['id_cliente'] ?>&v=<?php echo $row['id'] ?>" target="_blank" class="btn btn-danger" style="background-color:OrangeRed"><i class="fas fa-file-pdf"></i></a>

<a href="pdf/correo.pdf?cl=<?php echo $row['id_cliente'] ?>&v=<?php echo $row['id'] ?>" target="_blank" class="btn btn-danger" style="background-color:OrangeRed"><i class="fas fa-file-pdf"></i></a>
